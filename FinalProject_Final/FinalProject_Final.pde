...
void displayMenu()
{
  ...
  textSize(16);
  text("by Michael Whiter and Steven Var", width/2 - 60, height/4 + 24);
  text("Use arrow keys or WASD to move", 40, height-80);
  text("Press the spacebar to shoot", 40, height-60);
  text("Press the X key to fire a lynx missile", 40, height-40);
  text("When it is near enemies, press X again to denoate it, dealing damage in a wide area", 40, height-20);
  textFont(myFont);
  fill(0,0,0);
